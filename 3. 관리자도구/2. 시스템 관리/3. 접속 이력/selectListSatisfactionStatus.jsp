...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnGoPage(currentPage) {
            ...
            $("#aform").attr({action: "/admin/stats/selectListSatisfactionStatus.do", method: 'post'}).submit();
        }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form role="form" id="aform" method="post" action="/admin/stats/selectListSatisfactionStatus.do">
                            ...
                            <div class="box-body no-pad-top table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><%=dataMap.getString("STSFDG_SCORE") %>
                                        </td>
                                        <td class="text-left"><a href="<%=dataMap.getString("URL_QUERY") %>"
                                                                 target="_blank"><%=dataMap.getString("URL_QUERY") %>
                                        </a></td>
