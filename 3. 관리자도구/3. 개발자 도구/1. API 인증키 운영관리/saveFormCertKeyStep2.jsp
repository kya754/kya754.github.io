    ...
    <script type="text/javascript">
        ...
        function fnUnUse() {
            ...
            if (confirm("사용중지하시겠습니까?")) {
                $("#aform").attr({action: "/iot/certkey/saveCertKeyStep2UnUse.do", method: 'post'}).submit();
            }
        }
        ...
        function fnReUse() {
            ...
            if (confirm("재사용하시겠습니까?")) {
                $("#aform").attr({action: "/iot/certkey/saveCertKeyStep2ReUse.do", method: 'post'}).submit();
            }
        }
        ...
        function fnSave() {
            ...
            jQuery.ajax({
                type: 'POST',
                dataType: 'json',
                url: '/iot/certkey/chkExistModlSerialAjax.do',
                data: req,
                success: function (param) {
                    ...
                    if (confirm("저장하시겠습니까?")) {
                        $("#aform").attr({
                            action: "/iot/certkey/saveCertKeyStep2.do",
                            method: 'post'
                        }).submit();
                    }
        ...
        function fnGoPage(currentPage) {
            ...
            $("#aform").attr({action: "/iot/certkey/saveFormCertKeyStep2.do", method: 'post'}).submit();
        }
                        ...
                        <div class="box box-primary">
                            <div class="box-body table-responsive no-padding">
                                <table id="codeTable" class="table table-bordered">
                                    ...
                                    <thead>
                                    <tr>
                                        <th class="text-center"><input type="checkbox" id="all_chkbx1"/></th>
                                    ...
                                    %>
                                    <input type="hidden" id="old_modl_serial" name="old_modl_serial"
                                           value="<%=dataMap.getString("MODL_SERIAL") %>"/>
                                    <tr>
                                        <input type="hidden" id="use_yn" name="use_yn"
                                               value="<%= dataMap.getString("USE_YN") %>"/>
                                        <td class="text-center"><input type="checkbox" name="del_chkbx"
                                                                       value="<%=dataMap.getString("MODL_SERIAL") %>"/>
                                        </td>
                                        <td class="text-center"><%=dataNo - i %>
                                        </td>
                                        <td><input type="text" name="modl_serial" class="form-control"
                                                   value="<%=dataMap.getString("MODL_SERIAL") %>" maxlength="20"/></td>
                                        <td><input type="text" name="post_no" class="form-control numeric"
                                                   value="<%=dataMap.getString("POST_NO") %>" maxlength="5"/></td>
                                        <td><input type="text" name="adres" class="form-control"
                                                   value="<%=dataMap.getString("ADRES") %>" maxlength="100"/></td>
                                        <td><input type="text" name="adres_detail" class="form-control"
                                                   value="<%=dataMap.getString("ADRES_DETAIL") %>" maxlength="100"/>
                                        </td>
                                        <td>
                                            <select name="crdnt_code" class="form-control input-sm">
                                                <%=CommboUtil.getComboStr(crdntSeComboStr, "CODE", "CODE_NM", dataMap.getString("CRDNT_CODE"), "")%>
                                            </select>
                                        </td>
                                        <td><input type="text" name="la" class="form-control"
                                                   value="<%=dataMap.getString("LA") %>" maxlength="50"/></td>
                                        <td><input type="text" name="lo" class="form-control"
                                                   value="<%=dataMap.getString("LO") %>" maxlength="50"/></td>
                                        <td><input type="text" name="antcty" class="form-control numeric"
                                                   value="<%=dataMap.getString("ANTCTY") %>" maxlength="11"/></td>
                                        <td><input type="text" name="buld_nm" class="form-control"
                                                   value="<%=dataMap.getString("BULD_NM") %>" maxlength="50"/></td>
                                        <td><input type="text" name="instl_floor" class="form-control"
                                                   value="<%=dataMap.getString("INSTL_FLOOR") %>" maxlength="11"/></td>
                                        <td><input type="text" name="instl_ho_no" class="form-control numeric"
                                                   value="<%=dataMap.getString("INSTL_HO_NO") %>" maxlength="11"/></td>
                                        <td><input type="text" name="rm" class="form-control"
                                                   value="<%=dataMap.getString("RM") %>" maxlength="100"/></td>
                                    </tr>
                                    <% }%>
                                    </tbody>
                                </table>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table id="unUseTable" class="table table-bordered">
                                    ...
                                    %>
                                    <input type="hidden" id="oldModl_serial" name="oldModl_serial"
                                           value="<%=unUseDataMap.getString("MODL_SERIAL") %>"/>
                                    <tr>
                                        <input type="hidden" id="use_yn" name="use_yn"
                                               value="<%=unUseDataMap.getString("USE_YN") %>"/>
                                        <td class="text-center"><input type="checkbox" name="reUse_chkbx"
                                                                       value="<%=unUseDataMap.getString("MODL_SERIAL") %>"/>
                                        </td>
                                        ...
                                        <td><%=unUseDataMap.getString("CRDNT_NM") %>
                                        </td>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    <button type="button" class="btn btn-info"
                                            onclick="return fnReUse(); return false;"><i class="fa fa-pencil"></i> 사용
                                        재시작
                                    </button>
                                </div>
                            </div>
