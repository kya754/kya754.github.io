...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSave() {
            ...
            if (confirm("저장하시겠습니까?")) {
                $("#aform").attr({
                    action: "/iot/srvcInfo/saveSrvcInfoStep4.do",
                    method: 'post'
                }).submit();
            }
        }
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table id="codeTable" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">패킷 구분</th>
                                        <th class="text-center">그룹 코드</th>
                                        <th class="text-center">그룹 코드명</th>
                                        <th class="text-center">DATA 코드</th>
                                        <th class="text-center">DATA 코드명</th>
                                        <th class="text-center">패킷 명</th>
                                        <th class="text-center">패킷 길이</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=CommboUtil.getComboName(packetSeComboStr, "CODE", "CODE_NM", dataMap.getString("PACKET_SE_CODE"))%>
                                        </td>
                                        <td><%=dataMap.getString("GROUP_ID") %>
                                        </td>
                                        <td><%=dataMap.getString("GROUP_NM") %>
                                        </td>
                                        <td><%=dataMap.getString("CODE") %>
                                        </td>
                                        <td><%=dataMap.getString("CODE_NM") %>
                                        </td>
                                        <td><%=dataMap.getString("PACKET_NM") %>
                                        </td>
                                        <td><%=dataMap.getString("PACKET_BYTE") %>
                                        </td>
                                        <td><%=dataMap.getString("PACKET_UNIT") %>
                                        </td>
                                        <td><%=dataMap.getString("PACKET_CTGRY") %>
                                        </td>
                                        <td><%=dataMap.getString("DC") %>
                                        </td>
                                        <td><%=dataMap.getString("LIMIT_VALUE") %>
                                        </td>
                                        <td><%=dataMap.getString("CECK_PTTRN") %>
                                        </td>
                                        <td><%=CommboUtil.getComboName(publicYn, "CODE", "CODE_NM", dataMap.getString("PUBLIC_YN"))%>
                                        </td>
                                        <td><%=CommboUtil.getComboName(graphYn, "CODE", "CODE_NM", dataMap.getString("GRAPH_YN"))%>
                                        </td>
                                        <td><%=dataMap.getString("SORT_ORDR") %>
                                        </td>
                                    </tr>
                                    <% }%>
                                    </tbody>
