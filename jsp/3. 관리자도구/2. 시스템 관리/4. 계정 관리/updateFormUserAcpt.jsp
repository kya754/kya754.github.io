...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnGoUpdate() {
            ...
            if (confirm("수정하시겠습니까?")) {
                $("#aform").attr({action: "/admin/user/updateUserAcpt.do", method: 'post'}).submit();
            }
        }
            ...
            $.ajax({
                ...
                success: function (param) {
                    ...
                    for (var i = 0; i < param.resultMap.length; i++) {
                        ...
                        html += '		<input type="radio" name="author_id" id="' + author + '"'
                            + ' 		value="' + authorId + '">' + authorNm;
                        html += ' 	</label>';
                        html += ' </div>';
                    }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form role="form" id="aform" method="post" action="/admin/user/updateUserAcpt.do">
                        <input type="hidden" id="user_no" name="user_no" value="<%=resultMap.getString("USER_NO") %>"/>
                        <input type="hidden" id="cttpc" name="cttpc"/>
                        <input type="hidden" id="cttpc_se_code" name="cttpc_se_code"
                               value="<%=resultMap.getString("CTTPC_SE_CODE") %>"/>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" class="form-control" id="user_nm" name="user_nm"
                        ...
                        <div class="box box-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            [<%=resultMap.getString("CTTPC_SE_NM") %>] <%=resultMap.getString("CTTPC") %>
                                                <%}%>
                                            <input type="hidden" name="cttpc1" class="form-control numeric"
                                                   maxlength="4" title="전화번호 첫번째 입력칸입니다" style="width:80px;"/>
                                            <input type="hidden" name="cttpc2" class="form-control numeric"
                                                   maxlength="4" title="전화번호 두번째 입력칸입니다" style="width:80px;"/>
                                            <input type="hidden" name="cttpc3" class="form-control numeric"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" class="form-control" name="email1" placeholder="이메일"
                                           maxlength="40" style="display:inline-block; width:150px"/>
                                    <input type="hidden" class="form-control" name="email2" placeholder="도메인"
                                           maxlength="40" style="display:inline-block; width:150px"/>
                                </td>
                            </tr>
                            </tbody>
