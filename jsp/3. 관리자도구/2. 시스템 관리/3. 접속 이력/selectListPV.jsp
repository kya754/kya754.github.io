...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnGoPage(currentPage) {
            ...
            $("#aform").attr({action: "/admin/stats/selectListPV.do", method: 'post'}).submit();
        }

        // 검색
        function fnSearch() {
            $("#currentPage").val("1");
            $("#aform").attr({action: "/admin/stats/selectListPV.do", method: 'get'}).submit();
        }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form role="form" id="aform" method="post" action="/admin/stats/selectListPV.do">
                            ...
                            <div class="box-header">
                                <div class="text-right form-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">기관 :</label>
                                        <select name="sch_organ_code" class="form-control input-sm"
                                                onchange="fnSearch();">
                                            <%= CommboUtil.getComboStr(organComboStr, "CODE", "CODE_NM", param.getString("sch_organ_code"), "A") %>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">일자 :</label>
                                        ...
                                        <input type="text" class="form-control input-sm" name="sch_end_de"
                                               value="<%=param.getString("sch_end_de")%>"/>
                                    </div>
                                    <div class="form-group">
