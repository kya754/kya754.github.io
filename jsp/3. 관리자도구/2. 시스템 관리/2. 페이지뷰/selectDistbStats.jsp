...
<head>
    ...
    <script type="text/javascript">
        ...
        // 검색
        function fnSearch() {
            $("#aform").attr({action: "/iot/statsservice/selectDistbStats.do", method: 'post'}).submit();
        }

        // 시스템 통계 엑셀 다운로드
        function fnExceldownload() {
            $("#aform").attr({action: "/iot/statsservice/exceldownloadDistbStats.do", method: 'post'}).submit();
        }
                    ...
                    <form id="aform" method="post">
                        <div class="box box-primary">
                            ...
                            <div class="box-body no-pad-top table-responsive" style="border: 0px;">
                                <div class="sub_tbl_scroll_box_3h">
                                    <div class="sub_fix_th_bg_3h"></div>
                                    <div class="sub_fix_wrap">
                                        <table class="table table-bordered table-striped dataTable">
                                            ...
                                            <thead>
                                            <tr>
                                                <th rowspan="2" scope="col" style="width: 3%;">
                                                    <div class="sub_fix_th_3h">번호</div>
                                                </th>
                                                <th rowspan="2" scope="col" style="width: 6%;">
                                                    <div class="sub_fix_th_3h">구축년도</div>
                                                </th>
                                                <th rowspan="2" scope="col" style="width: 7%;">
                                                    <div class="sub_fix_th_3h">기관 명</div>
                                                </th>
                                                <th rowspan="2" scope="col" style="width: 18%;">
                                                    <div class="sub_fix_th_3h">서비스 명</div>
                                                </th>
                                                <th rowspan="2" colspan="2" scope="col" style="width: 12%;">
                                                    <div class="sub_fix_th_3h">서비스 분류 체계</div>
                                                </th>
                                                <th rowspan="2" scope="col" style="width: 6%;">
                                                    <div class="sub_fix_th_3h">연계 일자</div>
                                                </th>
                                                <th colspan="2" scope="col" style="width: 9%;">
                                                    <div class="sub_fix_th_2h">시각화 실행 수</div>
                                                </th>
                                                <th colspan="2" scope="col" style="width: 9%;">
                                                    <div class="sub_fix_th_2h">서비스 조회 수</div>
                                                </th>
                                                <th colspan="2" scope="col" style="width: 9%;">
                                                    <div class="sub_fix_th_2h">파일 다운로드 수</div>
                                                </th>
                                                <th colspan="2" scope="col" style="width: 9%;">
                                                    <div class="sub_fix_th">디지털 시민 시장실<br>연계 건수</div>
                                                </th>
                                                <th colspan="2" scope="col" style="width: 9%;">
                                                    <div class="sub_fix_th">열린 데이터 광장<br>연계 건수</div>
                                                </th>
                                                <th colspan="2" scope="col" style="width: 9%;">
                                                    <div class="sub_fix_th">협치 시스템 <br>연계 건수</div>
                                                </th>
                                            </tr>
                                            <tr>
                                                <th scope="col" style="width: 4.5%;">
                                                    <div class="sub_fix_th_3h">기간</div>
                                                </th>
                                                <th scope="col" style="width: 4.5%;">
                                                    <div class="sub_fix_th_3h">전체</div>
                                                </th>
                                                <th scope="col" style="width: 4.5%;">
                                                    <div class="sub_fix_th_3h">기간</div>
                                                </th>
                                                    ...
                                                    <c:forEach var="data" items="${resultList}" varStatus="status">
                                                        <tr>
                                                            ...
                                                            <td class="text-right" name="col_4">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.SI_TOT_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_5">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.FD_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_6">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.FD_TOT_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_7">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.DS_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_8">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.DS_TOT_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_9">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.YK_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_10">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.YK_TOT_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_11">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.HC_CNT}"/>
                                                            </td>
                                                            <td class="text-right" name="col_12">
                                                                <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                  value="${data.HC_TOT_CNT}"/>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </c:otherwise>
                                            ...
                                            <th class="text-right disabled_th" name="result_5"></th>
                                            <th class="text-right disabled_th" name="result_6"></th>
                                            <th class="text-right disabled_th" name="result_7"></th>
                                            <th class="text-right disabled_th" name="result_8"></th>
                                            <th class="text-right disabled_th" name="result_9"></th>
                                            <th class="text-right disabled_th" name="result_10"></th>
                                            <th class="text-right disabled_th" name="result_11"></th>
                                            <th class="text-right disabled_th" name="result_12"></th>
                                            </tfoot>
                                        </table>
                                    </div>
                                </div>
