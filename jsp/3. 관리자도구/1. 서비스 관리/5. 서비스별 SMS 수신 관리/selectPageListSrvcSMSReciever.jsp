...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSearch() {
            $("#currentPage").val("1");
            $("#aform").attr({action: "/iot/sms/selectPageListSrvcSMSReciever.do", method: 'post'}).submit();
            fnSetServiceNmCombo();
        }
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <c:forEach var="data" items="${resultList}" varStatus="status">
                                        <tr style="cursor:pointer;cursor:hand;">
                                            ...
                                            <td class="text-center"
                                                onclick="fnDetail('${data.TRNSMIT_SERVER_NO}', '${data.DATA_NO}', '${data.ORGAN_CODE}','${data.SRVC_NM}')">${data.SERVER_NM}</td>
                                    ...
                                    <c:if test="${fn:length(resultList) == 0}">
                                        <tr>
                                            <td class="text-center" colspan="9"><spring:message
