...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('[name=sch_start_ymd_4]').datepicker({
                dateFormat: 'yy.mm.dd',
                changeYear: true,
                changeMonth: true
            });

            $('[name=sch_end_ymd_4]').datepicker({
                dateFormat: 'yy.mm.dd',
                changeYear: true,
                changeMonth: true
            });
        ...
        function fnGoPage(currentPage) {
            ...
            $("#aform").attr({action: "/iot/srvcRecptn/selectListDataRangeOverInfo.do", method: 'post'}).submit();
        }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form id="aform" method="post" action="iot/srvcRecptn/selectListDataRangeOverInfo.do">
                            ...
                            <div class="box-header">
                                <div class="text-right form-inline">
                                    <div class="form-group">
                                        <!--날자 검색-->
                                        <input type="text" class="form-control input-sm" id="sch_start_ymd_4"
                                               name="sch_start_ymd_4" placeholder="수신 시작일"
                                               value="<%=param.getString("sch_start_ymd_4")%>"/> -
                                        <input type="text" class="form-control input-sm" id="sch_end_ymd_4"
                                               name="sch_end_ymd_4" placeholder="수신 종료일"
                                               value="<%=param.getString("sch_end_ymd_4")%>"/>
                                    </div>
                                    <div class="form-group">
